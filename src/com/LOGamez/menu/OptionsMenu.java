...
//    private Configuration config;
    ...
    */
    ...
    private void initComponents() {
        ...
        lgePanelSize = new Dimension(Frogger.getMainWidth() - 40, Frogger.getMainHeight() - 20);
        ...
        mainPanel = new JPanel(){
            ...
            protected void paintComponent(Graphics g) {
                ...
                g.drawImage(mainPanelImage, 0, -10, Frogger.getMainWidth() - 40, Frogger.getMainHeight() - 20, null);
            }
        };
...
//        jCheckBox16.setOpaque(false);
        ...
        Frogger.optionsWindow.add(mainPanel);
    ...
    */
    ...
    public void tick(Game game, boolean up, boolean down, boolean left, boolean right, boolean fire) {
        ...
        if(OMfirstTick) {
            ...
            Frogger.addOptions();
            Frogger.setStatusBar("Options Menu");
            Frogger.optionsWindow.validate();
...
//    }
    ...
    */
    ...
    private void restoreDefBtnMouseEntered(MouseEvent evt) {  
        ...
        Frogger.setStatusBar("Restore Defaults");
    }                                     
    ...
    private void restoreDefBtnMouseExited(MouseEvent evt) {
        ...
        Frogger.setStatusBar("Developer");
    }                                    
    ...
    private void backBtnMouseEntered(MouseEvent evt) {                                      
        ...
        Frogger.setStatusBar("Back to Main Menu");
    }                                     
    ...
    private void back2MainMenu() {
        ...
        Frogger.removeOptions();
        Sound.Menu3.stop();
        
        game.requestFocus();
        game.setMenu(null);
        game.stateManager.setState("menu");
        Frogger.setStatusBar("Ready");
        Frogger.revalidate();
    }
    ...
    private void creditsMenu() {
        ...
        game.setCredits();
        game.requestFocus();
        Frogger.setStatusBar("Credits Menu");
    }
    ...
    private void defineBtnMouseEntered(MouseEvent evt) {
        ...
        Frogger.setStatusBar("Define Keys");
    }                                     
    ...
    private void defineKeys() {
        ...
        game.setMenu(null);
        game.stateManager.setState("menu");
        Frogger.setStatusBar("Define Keys Menu");
    }
    ...
    private void defKeysBtnMouseEntered(MouseEvent evt) {
        ...
        Frogger.setStatusBar("Default Keys");
    }                                     
