...
public class MenuState implements State {
    ...
    private int menuImageW = Frogger.getMainWidth()+12;
    
    /**menuImageH variable of MenuState*/
    private int menuImageH = Frogger.getMainHeight()-15;
    ...
    private int aboutBtnX = Frogger.getMainWidth() - 90;
    
    /**aboutBtnY variable of MenuState*/
    private int aboutBtnY = Frogger.getMainHeight() - 100;
    ...
    private int versionX = Frogger.getMainWidth() - 50;
    
    /**versionY variable of MenuState*/
    private int versionY = Frogger.getMainHeight() - 40;
    ...
    */
    ...
    public void render(Graphics2D g){
		...
		Frogger.setStatusBar("Quit?");
                
                //Set Quit Button Click Logic
                if (MouseInput.MouseButton == 1) {
                    Sound.stopAll();
                    Sound.btnPushed.play();
                    Frogger.setStatusBar("Quit Game?");
