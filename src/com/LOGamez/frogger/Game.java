...
public class Game extends Canvas implements Runnable {
    ...
    public static String TITLE = "Frogger";
    ...
    public Game(int width, int height){
       ...
       //If screen null create new screen : gameWidth, gameHeight args
        ...
        img = new BufferedImage(Frogger.getMainWidth(), Frogger.getMainHeight(), BufferedImage.TYPE_INT_RGB);
...
//            win();
    ...
    */
    public void win() {
        ...
        Frogger.setStatusBar("Time Bonus: "+timeBonus+" Accuracy Bonus: "+accuracyBonus+" Level Bonus: "+levelBonus);
        ...
        if(levelNo+1 < 21){//Game Levels Limit : Currently set to 8
            ...
            levelNo += 1;
            //level = new Level(levelNo, Frogger.getMainWidth(), Frogger.getMainHeight());
            ...
            //Frogger.setStatusBar("Loading Level "+levelNo+" : "+Level.getLevelName());
        } else {
            Frogger.setStatusBar("Game Complete!");
            //level = new Level(20, Frogger.getMainWidth(), Frogger.getMainHeight());
            //Level.levelComplete = false;
            pauseTime = 150;
